...
// Ensure only sekolah can access
...
<head>
    ...
    <title>Dashboard Sekolah - FoodEdu</title>
        ...
        <div class="navbar-inner">
            ...
            <nav class="nav-menu">
                ...
                <div class="nav-buttons">
                    <button class="btn-login" onclick="window.location.href='../auth.html'">Login</button>
        ...
        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 20px;">
            <div class="panel" style="padding: 30px;">
                ...
                <p><strong>Role:</strong> <span
                        style="background:#e6f4ea; color:var(--green); padding:2px 8px; border-radius:4px; font-size:12px; font-weight:600;">SEKOLAH</span>
                </p>
                <?php if (isset($user['sekolah'])): ?>
                    <p style="margin-top:8px;"><strong>Sekolah:</strong> <?php echo htmlspecialchars($user['sekolah']); ?>
                    </p>
                <?php endif; ?>
            ...
            <div class="panel" style="padding: 30px;">
                ...
                <a href="../pengaduan.php" class="btn-secondary"
                    style="display: block; text-align: center;">Pengaduan</a>
            </div>
        </div>
    </main>
